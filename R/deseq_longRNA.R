...
resmb <- get_results(ddsm, "mouse", "blood","total", 1, mh_orth, mp_orth, m_biotypes,"8")
resmb2 <- get_results(ddsm, "mouse", "blood","total", 1, mh_orth, mp_orth, m_biotypes,"2")
ddsmb <- ddsm
...
respb <- as.data.frame(get_results(ddsp, "pig", "blood", "total", 1, ph_orth, pm_orth, p_biotypes,"4"))
respb2 <- as.data.frame(get_results(ddsp, "pig", "blood", "total", 1, ph_orth, pm_orth, p_biotypes,"2"))
respb5 <- as.data.frame(get_results(ddsp, "pig", "blood", "total", 1, ph_orth, pm_orth, p_biotypes,"5"))
ddspb <- ddsp
